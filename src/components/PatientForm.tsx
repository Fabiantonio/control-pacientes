      ...
      >
        <div className="mb-5">
          ...
          <input
            ...
            {...register("name", {
              required: "Nombre paciente requerido",
            })}
          />
        ...
        <div className="mb-5">
          ...
          <input
            ...
            {...register("caretaker", {
              required: "Nombre Propietario requerido",
            })}
          />
          {errors.caretaker && <ErrorMsg>{errors.caretaker?.message}</ErrorMsg>}
        </div>
